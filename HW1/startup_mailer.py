...
# Account Information
to = 'zhouduoying@gmail.com' # Email to send to.
gmail_user = 'zhouduoying@gmail.com' # Email to send from. (MUST BE GMAIL)
gmail_password = '700503670718Aa' # Gmail password.
